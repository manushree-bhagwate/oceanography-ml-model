...
class_names = image_datasets.classes  # ['anadaman_seaweed', 'socotra_seaweed', 'madagascar_seagrass']
...
torch.save(model.state_dict(), "marine_flora_model.pth")
print("Model saved as marine_flora_model.pth")
